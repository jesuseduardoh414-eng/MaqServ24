...
export const defaultTheme: Theme = {
  ...
  copys: {
    es: {
      ...
      'product.card.quote': 'Cotizar',
      'product.card.added': 'Agregado',
      'product.tab.description': 'Descripción',
      'product.tab.specs': 'Ficha técnica',
      'product.tab.reviews': 'Opiniones',
      'product.tab.questions': 'Preguntas',
      'sector.about': 'Sobre este sector',
      'sector.services.title': 'Servicios incluidos',
      'sector.cta.title': '¿Interesado en este sector?',
      'sector.cta.body': 'Cuéntanos sobre tu obra y te preparamos una propuesta a la medida con la maquinaria adecuada.',
      'sector.cta.quote': 'Solicitar cotización',
      'sector.cta.catalog': 'Ver catálogo',
      'sector.band.title': '¿Necesitas maquinaria para este sector?',
      'sector.band.body': 'Nuestros especialistas te ayudan a elegir el equipo ideal para tu proyecto.',
      'sector.band.others': 'Ver otros sectores',
      'product.spec.brand': 'Marca',
      'product.spec.mode': 'Modalidad',
      'product.mode.rental': 'Renta',
      'product.mode.sale': 'Venta',
      'product.mode.service': 'Servicio',
      ...
      'auth.login.heading': 'Entra a tu cuenta',
      'auth.register.eyebrow': 'Es gratis',
      ...
      'auth.forgot.hint': 'Escribe tu correo y te enviaremos un enlace para restablecerla.',
      'auth.forgot.submit': 'Enviar enlace',
      'auth.forgot.back': 'Volver a iniciar sesión',
      'auth.forgot.done.title': 'Revisa tu correo',
      'auth.forgot.done.body': 'Si el correo existe, recibirás un enlace para restablecer tu contraseña.',
      'auth.logout': 'Salir',
      'auth.greeting': 'Hola',
      ...
      // Candado de cotizar (2026-09-23): el visitante mira; para pedir, cuenta.
      'quote.gate.eyebrow': 'Necesitas una cuenta',
      'quote.gate.title': 'Crea tu cuenta para cotizar',
      'quote.gate.body': 'Con tu cuenta no vuelves a capturar tus datos en cada solicitud, aceptas tus cotizaciones en línea y sigues tu servicio paso a paso. Es gratis y toma un minuto.',
      'quote.gate.register': 'Crear cuenta',
      'quote.gate.login': 'Ya tengo cuenta',
      'quote.gate.hint': 'Solo pedimos correo y contraseña. Lo demás lo completas cuando cotices.',
      'quote.gate.keep': 'Lo que elegiste se conserva: al entrar vuelves a este mismo punto.',
      'quote.form.emailLocked': 'Es el correo de tu cuenta: ahí te avisamos y con él entras a ver tu cotización.',
      'quote.form.phoneSaved': 'Tu teléfono se guarda en tu cuenta para no volver a pedirlo.',
      ...
      // metaTitle/metaDescription del panel.
      'seo.home.title': 'Renta de maquinaria y materiales para obra',
      'seo.home.description': 'Renta maquinaria pesada con operador, compra triturados y materiales, y contrata transporte o asfalto. Cotiza en línea y coordina tu obra en un solo lugar.',
      'seo.catalog.title': 'Catálogo de maquinaria, materiales y servicios',
      'seo.services.title': 'Servicios de maquinaria, transporte y materiales para obra',
      'seo.services.description': 'Renta de maquinaria con operador, pipas y volteos, triturados, materiales y soluciones asfálticas. Elige la máquina, ve el precio y solicita en línea.',
      'seo.catalog.description': 'Explora maquinaria pesada, triturados, materiales para construcción, transporte y soluciones asfálticas. Compara opciones y solicita tu cotización en línea.',
      'seo.categories.title': 'Categorías: maquinaria, triturados y servicios',
      'seo.categories.description': 'Cinco líneas de servicio para tu obra: maquinaria pesada, triturados, transporte y servicios de obra, materiales para construcción y soluciones asfálticas.',
      'seo.quoter.title': 'Cotizador en línea de maquinaria y triturados',
      'seo.quoter.description': 'Arma tu cotización paso a paso: renta de maquinaria con operador y diésel, o triturados por tonelada y por viaje. Recibes el documento al momento, listo.',
      'seo.quoter.machinery.title': 'Cotizador de renta de maquinaria con operador',
      'seo.quoter.machinery.description': 'Cotiza la renta de maquinaria pesada con operador y diésel: elige el equipo, los días de trabajo y el municipio de entrega, y recibe tu propuesta al instante.',
      'seo.quoter.aggregates.title': 'Cotizador de triturados: grava, arena y base',
      'seo.quoter.aggregates.description': 'Cotiza grava, arena, base y material de banco: por tonelada en planta o por viaje puesto en obra. Precio claro y documento listo para compartir con tu equipo.',
      'seo.about.title': 'Quiénes somos: maquinaria y servicios de obra',
      'seo.about.description': 'Conoce MAQSER24: la plataforma que conecta tu obra con proveedores de maquinaria pesada, triturados, transporte y materiales, con cotización y seguimiento.',
      'seo.contact.title': 'Contacto para renta de maquinaria y materiales',
      'seo.contact.description': 'Escríbenos o llámanos para cotizar maquinaria, triturados, transporte o materiales para tu obra. Te respondemos por teléfono, WhatsApp o correo electrónico.',
      'seo.blog.title': 'Blog: guías de maquinaria y construcción',
      'seo.blog.description': 'Guías y consejos sobre renta de maquinaria, seguridad en obra, mantenimiento preventivo y costos de construcción, escritos para quien coordina proyectos.',
      'seo.privacy.title': 'Aviso de privacidad: cómo cuidamos tus datos',
      'seo.privacy.description': 'Lee cómo MAQSER24 recopila, usa y protege tus datos personales, con qué fin los trata y cómo ejercer tus derechos ARCO conforme a la ley mexicana de datos.',
